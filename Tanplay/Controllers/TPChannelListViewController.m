...
- (void)viewDidLoad
{
    ...
    else if(self.channelProvider == CP_XIAMI)
    {
        [TPXiamiFMProvider sharedProvider].channelListViewController = self;
        self.title = @"虾米电台";  
    }
...
{
    NSInteger section = 1;
    if(self.channelProvider == CP_XIAMI)
    {
        section = [TPXiamiFMProvider sharedProvider].categories.count;
    }
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    {
        TPXiamiCategory *cat = [[TPXiamiFMProvider sharedProvider].categories objectAtIndex:section];
        return cat.channelList.count;
    }
...
- (UITableViewCell *)tableView:(UITableView *)_tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        TPXiamiCategory *cat = [[TPXiamiFMProvider sharedProvider].categories objectAtIndex:indexPath.section];
        NSString *text = ((TPXiamiChannel*)[cat.channelList objectAtIndex:indexPath.row]).channelName;
        cell.textLabel.text = text;       
    }
...
- (void)showPlayer
{
    ...
    {
        [[TPXiamiFMProvider sharedProvider] showPlayerView:self];
    }
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        [[TPXiamiFMProvider sharedProvider] playChannel:indexPath];
    }
